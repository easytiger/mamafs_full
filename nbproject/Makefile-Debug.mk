...
${OBJECTDIR}/SubscriptionStore.o: SubscriptionStore.cc 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -g -I../../src/wombat_products_4.0/include/ -o ${OBJECTDIR}/SubscriptionStore.o SubscriptionStore.cc
...
${OBJECTDIR}/SubscriptionEntity.o: SubscriptionEntity.cc 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -g -I../../src/wombat_products_4.0/include/ -o ${OBJECTDIR}/SubscriptionEntity.o SubscriptionEntity.cc

${OBJECTDIR}/CLParser.o: CLParser.cc 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -g -I../../src/wombat_products_4.0/include/ -o ${OBJECTDIR}/CLParser.o CLParser.cc
